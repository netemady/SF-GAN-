...
class graph2graph(object):
    def __init__(self, sess, test_dir, train_dir, image_size, output_size,
                 batch_size, L1_lambda, epoch, lr_g, lr_d, sample_size=1,
                 gf_dim=5, df_dim=5,
    ...
    def train(self, args, sc, fc):
        ...
        d_optim = tf.train.AdamOptimizer(self.lr_d, beta1=args.beta1) \
            .minimize(self.d_loss, var_list=self.d_vars)

        g_optim = tf.train.AdamOptimizer(self.lr_g, beta1=args.beta1) \
        ...
        for epoch in xrange(self.epoch):
            ...
            if epoch % 200 == 0 or epoch == self.epoch - 1:
