...
class graph2graph(object):
    ...
    def build_model(self):
        ...
        self.fake_B, self.d3, self.d2_w = self.generator(self.real_A, self.node, self.features, nn)
    ...
    def train(self, args, sc, fc, ff1_new_train, lambda2, setting_value, nn):
    ...
    def generator(self, image, node, features, nn):
        #nn = 161
    ...
    def test(self, args, sc, fc, ff1_new_test, nn):
